...
})({"iqcxc":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3d2e1962c2ff8f2c";
"use strict";
        ...
        if (user) {
            if (!isLogged) {
                ...
                compImages.forEach((image)=>{
                    ...
                    if (testRest) {
                        if (imgPos == 0 && imgComp == orderedRest[0].key || imgPos == 1 && imgComp == orderedRest[1].key || imgPos == 2 && imgComp == orderedRest[2].key) image.classList.remove("hidden");
                        else image.classList.add("hidden");
                    } else {
                        containerX.classList.add("hidden");
                        important.innerHTML = "\xa1Recuerda hacer tu Test de Competencias para completar tu perfil!";
                    }
                });
...
function getOrderedResults(testResults) {
    ...
    for(const key in testResults)if (testResults.hasOwnProperty(key)) orderedResults.push({
        key,
